...
from giskardpy.configs.giskard import Giskard, ControlModes
...
class TiagoBase(Giskard):
    ...
    def configure_world(self):
        ...
        robot_group_name = self.world_config.add_robot_from_parameter_server()
        root_link_name = self.world_config.get_root_link_of_group(robot_group_name)
    ...
    def configure_collision_avoidance(self):
        self.collision_avoidance_config.load_self_collision_matrix('package://giskardpy/self_collision_matrices/iai/tiago_dual.srdf')
...
class TiagoMujoco(TiagoBase):
    ...
    def configure_robot_interface(self):
        self.robot_interface_config.sync_joint_state_topic('/tiago/joint_states')
        self.robot_interface_config.sync_odometry_topic(odometry_topic='/tiago/base_footprint',
        ...
        self.robot_interface_config.add_base_cmd_velocity(cmd_vel_topic='/tiago/cmd_vel',
                                                          joint_name=self.drive_joint_name)
...
class Tiago_Standalone(TiagoBase):
    ...
    def configure_behavior_tree(self):
        ...
        self.behavior_tree_config.add_visualization_marker_publisher(add_to_sync=True, add_to_control_loop=True)
    ...
    def configure_robot_interface(self):
        ...
        self.robot_interface_config.register_controlled_joints(['arm_right_1_joint', 'arm_right_2_joint', 'arm_right_3_joint',
