...
class TreeManager(object):
    ...
    def __init__(self, god_map, robot_names, namespaces, tree=None):
        ...
        world.delete_all_but_robots(self.robot_names)
    ...
    def from_param_server(cls, robot_names, namespaces):
        god_map = GodMap.init_from_paramserver(rospy.get_name(), robot_names, namespaces)
...
class OpenLoop(TreeManager):
    ...
    def grow_sync_branch(self):
        ...
        for group_name, namespace in zip(self.robot_names, self.namespaces):
            ...
            sync.add_child(SyncLocalization('{}: update robot localization'.format(namespace), group_name, namespace))
