...
class JointGoalSplitter:
    def __init__(self):
        ...
        self.base_client = actionlib.SimpleActionClient('/follow_joint_trajectory/base', control_msgs.msg.FollowJointTrajectoryAction)
        self.arm_client = actionlib.SimpleActionClient('/follow_joint_trajectory/body',
                                                        control_msgs.msg.FollowJointTrajectoryAction)

        self.base_joints = rospy.wait_for_message('/base/state', control_msgs.msg.JointTrajectoryControllerState).joint_names
        self.arm_joints = rospy.wait_for_message('/body/state', control_msgs.msg.JointTrajectoryControllerState).joint_names
