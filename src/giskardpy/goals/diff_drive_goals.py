...
class PR2DiffDriveOrient(Goal):
    ...
    def __init__(self, eef_link, max_linear_velocity: float = 0.1,
        ...
        self.eef_tip_link = god_map.world.get_link_name(eef_link)
        # self.root_T_goal = self.transform_msg(self.root_link, goal_pose)

    def make_constraints(self):
        base_root_T_base_tip = god_map.world.compose_fk_expression(self.base_root_link, self.base_tip_link)

        base_tip_T_eef_tip = god_map.world.compose_fk_expression(self.base_tip_link, self.eef_tip_link)
