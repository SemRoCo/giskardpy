...
class PlotGanttChart(GiskardBehavior):
    ...
    def plot_gantt_chart(self, tasks: List[MotionGraphNode], monitors: List[MotionGraphNode], file_name: str):
        ...
        thing_positions = {**task_positions, **monitor_positions}
        thing_names = task_names + monitor_names
    ...
    def plot_history(self,
        ...
        for end_time, (bool_states, history_states) in history:
            for thing_id, status in enumerate(history_states):
                ...
                inner_color = plot_motion_graph.ObservationStateToColor[bool(last_bool_status)]
