...
class InitQPController(GiskardBehavior):
    ...
    @profile
    def update(self):
        eq_constraints, neq_constraints, derivative_constraints, manip_constraints, quadratic_weight_gains, linear_weight_gains = god_map.motion_goal_manager.get_constraints_from_goals()
