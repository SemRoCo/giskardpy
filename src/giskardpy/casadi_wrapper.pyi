...
class Symbol_:
    ...
    def __setitem__(self, key, value: symbol_expr_float): ...
...
class Symbol(Symbol_):
    ...
    @overload
    def __add__(self, other: RotationMatrix) -> RotationMatrix: ...
    @overload
    def __add__(self, other: TransMatrix) -> TransMatrix: ...
    @overload
...
class Point3(Symbol_):
    ...
    @overload
    def dot(self, other: RotationMatrix) -> Point3: ...
    @overload
    def dot(self, other: TransMatrix) -> Point3: ...
...
class Vector3(Symbol_):
    ...
    def dot(self, other: Vector3) -> Expression: ...
    @overload
    def dot(self, other: RotationMatrix) -> Vector3: ...
    @overload
    def dot(self, other: TransMatrix) -> Vector3: ...
...
class RotationMatrix(Symbol_):
    ...
    @overload
    def dot(self, other: TransMatrix) -> RotationMatrix: ...
...
@overload
def save_division(nominator: Vector3, denominator: symbol_expr_float, if_nan: Vector3) -> Vector3: ...
@overload
def save_division(nominator: Point3, denominator: symbol_expr_float, if_nan: Point3) -> Point3: ...
@overload
...
def if_eq_cases(a: symbol_expr_float,
                b_result_cases: Union[Iterable[Tuple[symbol_expr_float, symbol_expr_float]], Expression],
                else_result: symbol_expr_float) -> Expression: ...
...
def quaternion_slerp(q1: Expression, q2: Expression, t: symbol_expr_float) -> Expression: ...
...
def angle_between_vector(v1: Expression, v2: Expression) -> Expression: ...
