...
class TestSymengineController(unittest.TestCase):
    pr2_joint_limits = Robot.from_urdf_file(u'../test/pr2.urdf').get_joint_limits()
    donbot_joint_limits = Robot.from_urdf_file(u'../test/iai_donbot.urdf').get_joint_limits()
    boxy_joint_limits = Robot.from_urdf_file(u'../test/boxy.urdf').get_joint_limits()
