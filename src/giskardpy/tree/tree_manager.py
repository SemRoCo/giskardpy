...
from giskardpy.utils.utils import get_all_classes_in_package, create_path
...
class TreeManager(object):
    ...
    def grow_planning2(self):
        ...
        if self.god_map.get_data(identifier.enable_CPIMarker) and self.god_map.get_data(identifier.collision_checker) is not None:
