...
class CartesianPositionStraight(Goal):
    ...
    def make_constraints(self):
        ...
        self.add_inequality_constraint_vector(reference_velocities=[self.reference_velocity] * 3,
...
class DiffDriveBaseGoal(Goal):
    ...
    def make_constraints(self):
        ...
        self.add_inequality_constraint(reference_velocity=self.max_angular_velocity,
